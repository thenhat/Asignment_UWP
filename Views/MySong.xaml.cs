...
namespace I_Like_Music.Views
{
    ...
    public sealed partial class MySong : Page
    {
        ...
        private async void LoadMySongList(object sender, RoutedEventArgs e)

        {

            List<Song> songs = await this._getMySongService.LoadMySong();
        ...
        public void playButton()
        {
            ...
            if (currentSong == null)
            {
                currentSong = _getMySongService.LoadMySongs().FirstOrDefault();
                PlaySong(currentSong);
